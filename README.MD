...
1. **Introduction to pattern recognition** 
   ...
   [![nbviewer](https://img.shields.io/badge/-View-blue?logo=jupyter&style=flat&labelColor=gray)](https://nbviewer.jupyter.org/github.com/Wickstrom/pattern-recognition-handbook/blob/main/notebooks/00/intro.ipynb)
...
2. **Bayes decision theory** 
   ...
   [![nbviewer](https://img.shields.io/badge/-View-blue?logo=jupyter&style=flat&labelColor=gray)](https://nbviewer.jupyter.org/github/Wickstrom/pattern-recognition-handbook/blob/main/notebooks/01/bayes_decision_theory.ipynb?flush_cache=True)
...
3. **Density estimation** 
   ...
   [![nbviewer](https://img.shields.io/badge/-View-blue?logo=jupyter&style=flat&labelColor=gray)](https://github.com/Wickstrom/pattern-recognition-handbook/tree/main/notebooks/01/bayes_decision_theory.ipynb)
